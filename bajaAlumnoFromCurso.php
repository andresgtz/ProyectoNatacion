...
<head>
	...
	<body>
		...
		<div class="container">
			<h1 align="center">Datos de Baja</h1>
			<p class="lead" align="center">La baja se realizar&aacute; con los siguientes datos.</p>
			<!-- Codigo de la forma -->
			<div class="container">
				<form id ="formReg" form class="form-horizontal" action="bajaFinalizada.php" method="post">
					<fieldset>
