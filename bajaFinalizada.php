...
if($idCurso != -1){
		$sql= "DELETE FROM inscripcion WHERE IdCurso=$idCurso and IdAlumno=$idAlumno";
			...
			$body = "El motivo de este correo es para notificarle que su hijo $NombreAlumno ha sido dado de baja del curso $NombreCurso en los dias $DiasDeLaSemana a la hora $HoraInicio. ";
		...
		<body>
			...
			<div class="container">
				<div class="jumbotron">
					<h1>Baja realizada con &eacute;xito!</h1>
